...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conexao, "SELECT * FROM aluno WHERE idaluno = $id");
...
if(isset($_POST['update'])) {
    ...
    mysqli_query($conexao, "UPDATE aluno SET nome='$nome', email='$email', senha='$senha' WHERE idaluno=$id");
    header('Location: listaUsuarios.php'); // redireciona após editar
}
...
<body>
    ...
    <div class="menu-mobile">
        <ul>
            ...
            <li><a href="desafios.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
    ...
    <div class="menu-desktop">
        <nav>
            <ul>
                ...
                <li>
                    <a href="desafios.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            fill="currentColor" class="bi bi-journal-check" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M10.854 6.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 8.793l2.646-2.647a.5.5 0 0 1 .708 0" />
                            <path
    ...
    <form method="post" action="editusuario.php">
        <input type="hidden" name="id" value="<?php echo $user_data['idaluno']; ?>">
        <label>Nome:</label><br>
        <input type="text" name="nome" value="<?php echo $user_data['nome']; ?>"><br>
        <label>Email:</label><br>
        <input type="text" name="email" value="<?php echo $user_data['email']; ?>"><br>
        <label>Telefone:</label><br>
        <input type="text" name="senha" value="<?php echo $user_data['senha']; ?>"><br>
