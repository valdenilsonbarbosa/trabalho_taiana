...
if (!isset($_SESSION['email']) || !isset($_SESSION['senha'])) {
    ...
    if ($logado === 'gui@gmail.com' && $senha === '123456' || $logado === 'elias@gmail.com' && $senha === '123456') {
...
// Garante que as variáveis de POST existam para evitar erros.
$turma_id = $_POST['turma_id'] ?? null;
$titulo = $_POST['titulo'] ?? null;

// Verifica se os filtros são válidos. Se a turma_id não existir, o script para.
if (!$turma_id) {
    die("Filtros inválidos.");
}

// SQL ajustado: removido f.titulo da cláusula WHERE e adicionado o nome da turma.
...
// bind_param ajustado: 'i' para integer, já que a turma_id é um número
