...
if (isset($_POST['submit'])) {
  ...
  if (isset($_POST['livro'], $_POST['capitulo'], $_POST['fichamento'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO fichamento(fichamento,capitulo,turma,nome,titulo) values ('$fichamento','$capitulo',$turma,'$nome','$id')");
  } else {
...
<body>
  ...
  <div class="fichar-container">
    ...
    <form action="adicionar-fichamento.php" method="post" id="form">
